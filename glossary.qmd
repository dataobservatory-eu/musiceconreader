...
| Term                               | Description |
|------------------------------------|-------------|
| `quantity`                         |  The measured or estimated amount of music used or consumed (e.g., number of plays, hours listened). In music, it’s often abstract or indirect.           |
| `blanket license`                  |  A licensing agreement that allows the user (e.g., a radio station or venue) to use an entire music repertoire for a fixed fee, without negotiating individual song licenses.        |
| `quantity estimation`              |   A method of approximating how much music is used when direct usage data is missing. It relies on indirect sources (like surveys) and is often paired with shadow prices to infer value.             |
| `pricing`                          |   The process or strategy of setting a price for a product or service. It can be based on costs, value, competition, or market dynamics.          |
| `price`                            |  The amount of money exchanged for a good or service in the market. It reflects the value buyers are willing to pay under current conditions.           |
| `historical price`                 |  A past price at which a good or service was traded. It is often used in comparisons, trends, or asset valuation.           |
| `market price`                     |   The current price at which a good or service can be bought or sold in an open market. It results from the interaction of supply and demand.          |
| `shadow price`                     |  An estimated or implied price assigned to a good or service that doesn't have a direct market price. Often used in economic modelling or policy analysis.           |
| `royalty rate`                     | A percentage or fixed payment made to rights holders (like artists or inventors) for the ongoing use of their intellectual property.            |
| `tariff table`                     |   
A published schedule that lists standard licensing fees or royalty rates for different types of music use (e.g., radio, streaming, live events), often set by CMOs or regulatory bodies.          |
| `hedonic price method`             |  A valuation technique that breaks down a product’s price into the value of its characteristics. Commonly used to assess the value of intangible attributes, like quality or brand.           |
| `revenue`                          |             |
| `licensing fee`                    |   The payment made by a user (like a broadcaster or venue) for the legal right to use copyrighted music. It compensates the rights holder for usage and varies by format and scale.          |
| `net sales`                        |   The total sales revenue after deducting returns, discounts, and allowances. It reflects the actual earnings from sold goods or services.          |
| `valuation`                        |   The process of estimating the worth of an asset, such as a music catalog or copyright. It may consider revenue, market conditions, and legal rights.          |
| `economic value`                   |  The worth of a good or service based on the benefit it provides to individuals or society, whether through direct revenue or broader utility.           |
| `value in use`                     |  The revenue-generating potential of a music work or copyright when used in a specific way or context, such as streaming or licensing.           |
| `external value`                   |  The broader impact or benefit of a music work beyond market transactions, such as cultural enrichment, education, or community engagement.           |
| `discount rate`                    |  The interest rate used to calculate the present value of future income. It reflects the time value of money and the risk of future earnings.           |
| `future revenue`                   | Expected income from a music asset or license over time. It can come from royalties, licensing, or other uses.            |
| `present value of future revenues` |  The current worth of projected income, adjusted using a discount rate to account for risk and the time delay in receiving the revenue.           |
